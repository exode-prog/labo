    ...
    <div class="container">
        ...
        <form action="../traitement/traitcommandes.php" method="POST">
            ...
            <select class="form-control" name="id_client" id="id_inscription">
             ...
             <!-- Section Produits dans le Panier -->
            ...
            <?php foreach($produits_panier as $produit): ?>
                ...
                <div class="mb-3">
                    <label for="quantite_<?php echo $produit['id_panier']; ?>"><?php echo $produit['nom']; ?></label>
                    <input type="number" class="form-control" name="quantite_<?php echo $produit['id_panier']; ?>" id="quantite_<?php echo $produit['id_panier']; ?>" value="<?php echo $produit['quantite']; ?>" required>
