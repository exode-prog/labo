...
$selectProduit = "SELECT promotions.*, categories.nomcategorie 
                  FROM promotions 
                  JOIN categories ON promotions.idcategorie = categories.idcategorie 
                  WHERE id_promo = :id";
    ...
    <div class="product-details">
        ...
        <div class="product-info">
            ...
            <form action="pages/add_cookie.php" method="POST">
                ...
                <input type="hidden" name="id_promo" value="<?php echo $produit['id_promo']; ?>">
