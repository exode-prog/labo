...
<head>
    ...
    <title>keuryabt | Decorations</title>
                ...
                <div class="row">
                  <div class="image-overlay"> 
                    <div class="col-lg-12 text-center text-light"> 
                        <h1 class="text-transition fs-3 mb-3">DECORATIONS</h1> 
                    </div>
                </div>
            </div>
            </div>
...
<section class="bg-pink py-5">
    <div class="container">
        <h2 class="text-center mb-4">DECORATIONS</h2>
    ...
    <div class="pagination justify-content-center mt-4">
        <ul class="pagination">
            <?php if ($pageDecorations > 1) : ?>
                <li class="page-item"><a class="page-link" href="?page_decorations=<?php echo $pageDecorations - 1; ?>"><i class="bi bi-arrow-left"></i></a></li>
            <?php endif; ?>
            <?php for ($i = 1; $i <= $pagesDecorations; $i++) : ?>
                <li class="page-item <?php if ($i === $pageDecorations) echo 'active'; ?>"><a class="page-link" href="?page_decorations=<?php echo $i; ?>">Page <?php echo $i; ?></a></li>
            <?php endfor; ?>
            <?php if ($pageDecorations < $pagesDecorations) : ?>
                <li class="page-item"><a class="page-link" href="?page_decorations=<?php echo $pageDecorations + 1; ?>"><i class="bi bi-arrow-right"></i></a></li>
            <?php endif; ?>
        </ul>
    </div>
</section>
