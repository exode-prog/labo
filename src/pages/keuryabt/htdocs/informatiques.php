...
<head>
    ...
    <title>keuryabt | Informatique</title>
    ...
    <style>
      ...
      background-color: #f5f5f5;
        ...
        .section-background {
      background-image: url('css/image/WhatsApp Image 2024-05-25 at 12.41.48.jpeg');
      height: 400px; 
      position: relative; 
                ...
                <div class="row">
                  <div class="image-overlay"> 
                    <div class="col-lg-12 text-center text-light"> 
                        <h1 class="text-transition fs-3 mb-3">INFORMATIQUES</h1> 
                    </div>
                </div>
            </div>
            </div>
...
<section class="bg-pink py-5">
    <div class="container">
        <h2 class="text-center mb-4">INFORMATIQUES</h2>
    ...
    <ul class="pagination">
        <?php if ($pageInformatique > 1) : ?>
            <li class="page-item"><a class="page-link" href="?page_informatique=<?php echo $pageInformatique - 1; ?>"><i class="bi bi-arrow-left"></i></a></li>
        <?php endif; ?>
        <?php for ($i = 1; $i <= $pagesInformatique; $i++) : ?>
            <li class="page-item <?php if ($i === $pageInformatique) echo 'active'; ?>">
                <a class="page-link" href="?page_informatique=<?php echo $i; ?>">Page <?php echo $i; ?></a>
            </li>
        <?php endfor; ?>
        <?php if ($pageInformatique < $pagesInformatique) : ?>
            <li class="page-item"><a class="page-link" href="?page_informatique=<?php echo $pageInformatique + 1; ?>"><i class="bi bi-arrow-right"></i></a></li>
        <?php endif; ?>
    </ul>
</div>
