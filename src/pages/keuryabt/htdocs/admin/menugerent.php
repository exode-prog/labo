...
<body>
  ...
  <nav class="navbar navbar-expand-lg navbar-light bg-light justify-content-center">
    <ul class="navbar-nav text-center">
      ...
      <li class="nav-item">
        <a class="nav-link text-dark category-card" href="livraisonsger.php"><i class="fas fa-chart-line"></i>&nbspLIVRAISONS</a>
      </li>
      <li class="nav-item">
        <a class="nav-link text-dark category-card" href="statistiqueger.php"><i class="fas fa-chart-line"></i>&nbspTABLEAU DE BORD</a>
      </li>
      <li class="nav-item">
  ...
  <div class="container">
    <h4 class="header-title text-dark category-card">Bienvenue : <?= htmlspecialchars($_SESSION['user']->prenomu); ?> <?= htmlspecialchars($_SESSION['user']->nomu); ?></h4>
    <div class="row">
      <div class="col-md-4">
        <div class="card mb-4">
          <a href="categoriesger.php" class="text-decoration-none">
      ...
      <div class="col-md-4">
        <div class="card mb-4">
          <a href="produitsger.php" class="text-decoration-none">
            <div class="card-body text-center">
      ...
      <div class="col-md-4">
        <div class="card mb-4">
           <a href="promotionsger.php" class="text-decoration-none">
            <div class="card-body text-center">
    ...
    <div class="row">
      <div class="col-md-4">
        <div class="card mb-4">
          <a href="clientsger.php" class="text-decoration-none">
            <div class="card-body text-center">
      ...
      <div class="col-md-4">
        <div class="card mb-4">
          <a href="../pages/pageformation.php" class="text-decoration-none">
            <div class="card-body text-center">
