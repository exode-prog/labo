    ...
    <div class="col-md-6">
      <div class="card mb-4">
        <div class="card-body text-center">
          ...
          <p class="card-text">Ajoutez une nouvelle client à votre boutique.</p>
          <a href="../formulaire/client.php" class="btn btn-primary">Ajouter client</a>
        </div>
      </div>
    </div>
    <div class="col-md-6">
      <div class="card mb-4">
        <div class="card-body text-center">
          ...
          <p class="card-text">Affichez la liste de tous les clients de votre boutique.</p>
          <a href="../affichages/clientsger.php" class="btn btn-primary">Afficher clients</a>
        </div>
      </div>
    </div>
  </div>
