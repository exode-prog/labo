...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="../css/public/css/bootstrap.min.css">
    ...
    <div class="col-md-6">
      <div class="card mb-4">
        <div class="card-body text-center">
          ...
          <a href="../formulaire/livraisonsger.php" class="btn btn-primary">Ajouter livraison</a>
        </div>
      </div>
    </div>
    <div class="col-md-6">
      <div class="card mb-4">
        <div class="card-body text-center">
          ...
          <a href="../affichages/livraisonsger.php" class="btn btn-primary">Afficher livraisons</a>
        </div>
      </div>
    </div>
  </div>
