...
<head>
  ...
  <title>keuryabt | Gestion des categories</title>
    ...
    <div class="col-md-6">
      <div class="card mb-4">
        <div class="card-body text-center">
          ...
          <p class="card-text">Ajoutez une nouvelle categorie à votre boutique.</p>
          <a href="../formulaire/categoriesger.php" class="btn btn-primary">Ajouter categorie</a>
        </div>
      </div>
    </div>
    <div class="col-md-6">
      <div class="card mb-4">
        <div class="card-body text-center">
          ...
          <p class="card-text">Affichez la liste de tous les categories de votre boutique.</p>
          <a href="../affichages/categoriesger.php" class="btn btn-primary">Afficher Categories</a>
        </div>
      </div>
    </div>
  </div>
