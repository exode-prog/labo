    ...
    <div class="col-md-6">
      <div class="card mb-4">
        <div class="card-body text-center">
          ...
          <p class="card-text">Ajoutez une nouvelle promotion à votre boutique.</p>
          <a href="../formulaire/promotionsger.php" class="btn btn-primary">Ajouter promotion</a>
        </div>
      </div>
    </div>
    <div class="col-md-6">
      <div class="card mb-4">
        <div class="card-body text-center">
          ...
          <p class="card-text">Affichez la liste de tous les promotions de votre boutique.</p>
          <a href="../affichages/promotionsger.php" class="btn btn-primary">Afficher promotions</a>
        </div>
      </div>
    </div>
  </div>
