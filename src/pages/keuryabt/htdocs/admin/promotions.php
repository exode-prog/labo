    ...
    <div class="col-md-6">
      <div class="card mb-4">
        <div class="card-body text-center">
          ...
          <a href="../formulaire/promotions.php" class="btn btn-primary">Ajouter promotion</a>
        </div>
      </div>
    </div>
    <div class="col-md-6">
      <div class="card mb-4">
        <div class="card-body text-center">
          ...
          <a href="../affichages/promotions.php" class="btn btn-primary">Afficher promotions</a>
        </div>
      </div>
    </div>
  </div>
