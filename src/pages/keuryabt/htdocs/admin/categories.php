    ...
    <div class="col-md-6">
      <div class="card mb-4">
        <div class="card-body text-center">
          ...
          <a href="../formulaire/categories.php" class="btn btn-primary">Ajouter categorie</a>
        </div>
      </div>
    </div>
    <div class="col-md-6">
      <div class="card mb-4">
        <div class="card-body text-center">
          ...
          <a href="../affichages/categories.php" class="btn btn-primary">Afficher Categories</a>
        </div>
      </div>
    </div>
  </div>
