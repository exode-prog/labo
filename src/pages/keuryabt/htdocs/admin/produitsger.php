...
<head>
  ...
  <title>keuryabt | Gestion des produits</title>
    ...
    <div class="col-md-6">
      <div class="card mb-4">
        <div class="card-body text-center">
          ...
          <h5 class="card-title">Ajouter produit</h5>
          <p class="card-text">Ajoutez une nouvelle produit à votre boutique.</p>
          <a href="../formulaire/produitsger.php" class="btn btn-primary">Ajouter produit</a>
        </div>
      </div>
    </div>
    <div class="col-md-6">
      <div class="card mb-4">
        <div class="card-body text-center">
          ...
          <p class="card-text">Affichez la liste de tous les produits de votre boutique.</p>
          <a href="../affichages/produitsger.php" class="btn btn-primary">Afficher produits</a>
        </div>
      </div>
    </div>
  </div>
