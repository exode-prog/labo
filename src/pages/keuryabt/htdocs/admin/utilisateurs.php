...
<head>
  ...
  <title>keuryabt | Gestion des Utilisateurs</title>
    ...
    <div class="col-md-6">
      <div class="card mb-4">
        <div class="card-body text-center">
          ...
          <p class="card-text">Ajoutez un nouvel utilisateur à votre boutique.</p>
          <a href="../formulaire/utilisateurs.php" class="btn btn-primary">Ajouter Utilisateur</a>
        </div>
      </div>
    </div>
    <div class="col-md-6">
      <div class="card mb-4">
        <div class="card-body text-center">
          ...
          <p class="card-text">Affichez la liste de tous les utilisateurs de votre boutique.</p>
          <a href="../affichages/utilisateurs.php" class="btn btn-primary">Afficher Utilisateurs</a>
        </div>
      </div>
    </div>
  </div>
