...
<head>
  ...
  <title>amsik shop | Tableau des produits</title>
  ...
  <table id="tableUtilisateurs" class="table table-striped table-bordered">
    ...
    <tbody>
      ...
      <tr>
        ...
        <td>
          <a href="../formulaire/modiproduits.php?id=<?php echo $value ['idp']; ?>">
          <button class="btn btn-warning btn-sm"><i class="fas fa-edit"></i></button></a></td>
        <td>
           <a href="../traitement/suppproduitger.php?id=<?php echo $value['idp']; ?>" onclick="return confirm('Etes vous sûre de supprimer?')">
