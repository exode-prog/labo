  ...
  <table id="tableUtilisateurs" class="table table-striped table-bordered">
    ...
    <tbody>
      ...
      <tr>
        ...
        <td><a href="../formulaire/modicategories.php?id=<?php echo $value ['idcategorie']; ?>">
          <button class="btn btn-warning btn-sm"><i class="fas fa-edit"></i></button></a></td>
        <td> <a href="../traitement/suppcate.php?id=<?php echo $value['idcategorie']; ?>" onclick="return confirm('Etes vous sûre de supprimer?')">
