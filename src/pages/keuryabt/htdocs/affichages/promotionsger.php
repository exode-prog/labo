  ...
  <table id="tableUtilisateurs" class="table table-striped table-bordered">
    ...
    <tbody>
      ...
      <tr>
        ...
        <td>
          <a href="../formulaire/modipromotionsger.php?id=<?php echo $value ['idp']; ?>">
          <button class="btn btn-warning btn-sm"><i class="fas fa-edit"></i></button></a></td>
        <td><a href="../traitement/supppromotionger.php?id=<?php echo $value['idp']; ?>" onclick="return confirm('Etes vous sûre de supprimer?')">
