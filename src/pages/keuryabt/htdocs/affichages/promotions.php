...
<head>
  ...
  <title>amsik shop | Tableau des promotions</title>
...
<div class="container mt-5">
  ...
  <h1 class="mb-4 text-center">Tableau des promotions</h1>
  <table id="tableUtilisateurs" class="table table-striped table-bordered">
    ...
    <tbody>
      ...
      <tr>
        ...
        <td>
          <a href="../formulaire/modipromotions.php?id=<?php echo $value ['id_promo']; ?>">
          <button class="btn btn-warning btn-sm"><i class="fas fa-edit"></i></button></a></td>
        <td>
          <a href="../traitement/supppromotion.php?id=<?php echo $value['id_promo']; ?>" onclick="return confirm('Etes vous sûre de supprimer?')">
