...
if ($_SESSION['user']->typecompte == 'ADMIN') {
    ...
    // Vérification que l'id du produit est présent et est un entier
    if(isset($_GET['id']) && is_numeric($_GET['id'])) {
        $id = $_GET['id'];

        // Requête préparée pour récupérer les informations du produit à modifier
        ...
        // Gérer le cas où l'id est absent ou non valide
...
<div class="container mt-5">
   <div class="col-md-2">
        <a href="../affichages/produits.php">
