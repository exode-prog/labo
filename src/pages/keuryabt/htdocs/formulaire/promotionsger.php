...
<div class="container mt-5">
   <div class="col-md-2">
        <a href="../admin/promotionsger.php">
          <button type="button" class="btn btn-dark"><i class="fa fa-chevron-left"></i> Retour</button>
        </a>
      </div>
  <div class="form-container">
    <h1 class="mb-4 text-center">Ajouter une promotion</h1>
    <form action="../traitement/traitpromotions.php" method="POST" enctype="multipart/form-data">
      ...
      <div class="form-group">
        <label for="inputAncienPrix" class="form-label">Ancien Prix :</label>
        <input type="number" class="form-control" id="inputPrix" name="ancienprix" placeholder="Entrez le prix du produit" required>
        <div class="invalid-feedback">
          Veuillez entrer le prix du produit.
        </div>
      </div> 
      <div class="form-group">
        <label for="inputNouveauPrix" class="form-label">Nouveau Prix :</label>
        <input type="number" class="form-control" id="inputNouveauPrix" name="nouveauprix" placeholder="Entrez le prix du produit" required>
        <div class="invalid-feedback">
          Veuillez entrer le prix du produit.
        </div>
      </div>
