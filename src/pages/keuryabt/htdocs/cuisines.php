...
<div class="modal fade" id="searchModal" tabindex="-1" aria-labelledby="searchModalLabel" aria-hidden="true">
 ...
 <section class="py-5 bg-light section-background" data-aos="fade-up">
                ...
                <div class="row">
                  <div class="image-overlay"> 
                    <div class="col-lg-12 text-center text-light"> 
                        <h1 class="text-transition fs-3 mb-3">CUISINES</h1> 
                    </div>
                </div>
            </div>
            </div>
   ...
   <section class="bg-pink py-5">
    <div class="container">
        <h2 class="text-center mb-4">CUISINES</h2>
        <div class="row row-cols-2 row-cols-md-4 g-4">
            ...
            <div class="col">
                <div class="product d-flex flex-column align-items-center">
                    ...
                    <a href="detailproduit.php?id=<?php echo $produit['idp']; ?>" class="btn btn-success">J'achete</a>
                </div>
            </div>
          <?php endforeach; ?>  
    </div>
    <div class="pagination justify-content-center mt-4">
        <ul class="pagination">
            <?php if ($pageCuisines > 1) : ?>
                <li class="page-item"><a class="page-link" href="?page_cuisines=<?php echo $pageCuisines - 1; ?>"><i class="bi bi-arrow-left"></i></a></li>
            <?php endif; ?>
            <?php for ($i = 1; $i <= $pagesCuisines; $i++) : ?>
                <li class="page-item <?php if ($i === $pageCuisines) echo 'active'; ?>"><a class="page-link" href="?page_cuisines=<?php echo $i; ?>">Page <?php echo $i; ?></a></li>
            <?php endfor; ?>
            <?php if ($pageCuisines < $pagesCuisines) : ?>
                <li class="page-item"><a class="page-link" href="?page_cuisines=<?php echo $pageCuisines + 1; ?>"><i class="bi bi-arrow-right"></i></a></li>
            <?php endif; ?>
        </ul>
    </div>
</section>
